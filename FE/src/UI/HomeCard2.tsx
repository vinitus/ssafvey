...
export default function HomeCard2() {
  return (
    <div className="h-200 w-160 bg-main rounded-b-20 rounded-r-20 relative shadow-md shadow-black m-10">
      <div className="h-200 w-160 bg-clearMain rounded-b-20 rounded-r-20 opacity-30 absolute -left-4 -top-4"/>
