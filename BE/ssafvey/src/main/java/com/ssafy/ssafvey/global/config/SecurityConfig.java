...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers("/api/member/login**","/api/member/refresh","/api/survey/list**","/api/survey/start/**","/api/member/jobs","/api/shop/items/**","/api/member/tmpToken","/api/survey**","/api/member/mypage/**").permitAll()
                // 인증된 사용자만 접근
