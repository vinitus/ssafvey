...
import ssafvey.backend.config.jwt.JwtFilter;
import ssafvey.backend.config.jwt.TokenProvider;
...
import ssafvey.backend.exception.BadRequestException;
import ssafvey.backend.exception.UnAuthorizationException;
import ssafvey.backend.repository.MemberRepository;
...
public class MemberServiceImpl implements MemberService {
    ...
    @Transactional
    public void updateUser(int id,SignUpRequestDto signUpRequestDto){
        Optional<Member> findMember = memberRepository.findById(id);
        memberRepository.save(signUpRequestDto.tomember(findMember.get(),id,signUpRequestDto));
